...
def play_game():
    ...
    while not is_game_over:
        ...
        # If yes, then use the deal_card() function to add another card to the user_cards List. If no, then the game has ended.
            ...
            user_input = input("Do you want to draw another card? Type 'y' to continue or 'n' to exit: ").lower()
            if user_input == "y":
                user_cards.append(deal_card())
            else:
                is_game_over = True
...
#Hint 14: Ask the user if they want to restart the game. If they answer yes, clear the console and start a new game of blackjack 
